								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											?>
												<tr>
													<td><?php echo h($value['partner_provided_service']['service']);  ?></td>
													<td><?php echo h(date('Y-m-d' , strtotime($value['created_at']))); ?></td>
													<?php if(!empty($value['partner_service_schedulings'])) {
															foreach($value['partner_service_schedulings'] as $data) {
																if($data->scheduled_service_id == $value['id']) {
																?>
													...
													?>
													<?php } else { ?>
													<td><?php echo "NOT HIRED"; ?></td>
													<?php } ?>
										<td> <?php echo $this->Html->image("icon/payment.png", ["alt" => "payment","title"=>"payment",'url' => ['controller' => 'Reports', 'action' => 'payment',$value['id'] ]]); ?>
										<?php echo $this->Html->image("icon/rating.png", ["alt" => "Rating","title"=>"Rating", 'url' => ['controller' => 'Reports', 'action' => 'rating' ]]); ?>
										</td>	
												</tr>
											<?php } ?>	
											</tbody>
