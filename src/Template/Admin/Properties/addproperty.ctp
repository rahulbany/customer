...
<div id="main" role="main">
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			<li>Home</li><li>Tables</li><li>Add Property</li>
		</ol>
	</div>
							...
							<div role="widget" class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
								...
								<div role="content">
									...
									<div class="widget-body no-padding">
										...
										<?php echo $this->Form->create(@$userInfo, ['class'=>'smart-form','id'=>'addProperty']);  ?>												
											<fieldset class="conditional-customer">
												<div class="row">
													<section class="col col-10">
														<label class="input"> 
															<input type="text" name="street_address" placeholder="Street Address" id="street_address">
														</label>
													</section>
												</div>												
												<div class="row">
													...
													<section class="col col-5">
														<label class="select">
															<select name="size">
																...
																<option value="<?php echo $yard->id ?>"><?php echo ucfirst($yard->yards); ?></option>	
																<?php } ?>
															</select> <i></i> 
														</label>
													</section>
