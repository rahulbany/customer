		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					...
					<span>
						<a class="btn btn-success btn-lg pull-right header-btn hidden-mobile" href="#myModal" data-toggle="modal"><i class="fa fa-plus-square-o"></i> &nbsp;&nbsp;BOOKING</a>
					</span>
				</h1>
			</div>
		</div>
						...
						<div>
							...
							<div class="widget-body no-padding">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													<th data-hide="phone,tablet">Job Name</th>
													<th data-hide="phone">Street-Address</th>
													<th data-hide="phone">House_no</th>
											...
											<tr>
												<td><?php echo h($val['PartnerProvidedServices__service']); ?></td>
												<td><?php echo h($val['CustomerPropertys__street_address']);   ?></td>
												<td><?php echo h($val['CustomerPropertys__house_no']); ?></td>
												<td><?php echo h($val['CustomerPropertys__city']); ?></td>
												<td><?php echo h(date('Y-m-d' , strtotime($val['ScheduledServices__created_at']))); ?></td>
											</tr>
											<?php } ?>
											</tbody>
