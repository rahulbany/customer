						...
						<div>
							...
							<div class="widget-body no-padding">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													<th data-hide="phone,tablet">Jobs</th>
													<th data-hide="phone">Job List</th>
												</tr>
											</thead>
											<tbody>
											<?php foreach($jobs as $value) { ?>
										<tr> 
											<td><?php echo $value->partner_provided_service->service; ?> </td>
											<td> <?php echo $this->Html->image("icon/view.png", [ "alt" => "View",'url' => ['controller' => 'jobs', 'action' => 'view', $value->partner_provided_service->id]]); ?></td>						
										</tr>
										<?php } ?>
											</tbody>
										</table>
