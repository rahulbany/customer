...
<div id="main" role="main">
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			<li>Home</li><li>Tables</li><li>Change Password</li>
		</ol>
	</div>
							...
							<div role="widget" class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
								...
								<div role="content">
									...
									<div class="widget-body no-padding">
										...
										<?php echo $this->Form->create(@$userInfo, ['class'=>'smart-form','id'=>'changePwd']);  ?>	
											<fieldset>					
												<section>
...
<?php echo $this->Html->script('plugin/pace/pace.min.js'); ?>
	...
	function submitFormData(){
		...
		messages: {  			
			"opass": {required: "This field is required"},
			"new_pass": {required: "This field is required"},
			"confirm_pass" : { required: "This field is required"},				
		},	
		});	
